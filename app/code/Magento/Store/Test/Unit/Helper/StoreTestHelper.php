...
class StoreTestHelper implements StoreInterface
{
    ...
    {
        return 'test_store_' . $this->storeId;
    }
    public function getName()
    {
        return 'Test Store ' . $this->storeId;
    }
    ...
    public function getSecureBaseUrl($type = null)
    {
        return 'https://example.com/';
    }
    ...
    public function getCurrentUrlNoScript($fromStore = true)
    {
        return 'https://example.com/';
    }
    ...
    public function setBaseUrl($baseUrl, $type = null)
    {
        return $this;
    }
    ...
    public function setSecureBaseUrl($secureBaseUrl, $type = null)
    {
        return $this;
    }
